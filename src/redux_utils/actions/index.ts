...
export const addRestaurants = (restaurants: I.IRestaurantObject[]): I.IAddRestaurantAction => ({
...
export const changeCurrentPage = (changer: number): I.IChangeCurrentPageAction => ({
