...
describe("applySearch", () => {
  ...
  it('should return true if restaurant genre matchs query', () => {
    ...
    expect(mockRestaurant.genre)
      .toEqual('Steak,American,Contemporary,Seafood,Cafe');
...
describe("applyFilters", () => {
  it('should return the filteres array after implementing all filters', () => {
    ...
    const result: IRestaurantObject[] = utils.applyFilters(mockStore.restaurants, filters);
